...
абсолютный:  
$$\Delta = (T_0 - T_{\text{curr}}) / T_0 \cdot 100\% $$
где:
...
| Хэш-функция | Время (-O0, такты) | Среднее отклонение времени (такты) | Процентная ошибка (%) |
|-------------|--------------------| ---------------------------------- | --------------------- |
| PJW32       | 1360855            |  45588.64                          |  3.35                 |                                    
| Adler32     | 1486180            |  29872.21                          |  2.01                 |
| SDBM32      | 1472729            |  27540.03                          |  1.87                 |
| FNV32       | 1369590            |  57385.82                          |  4.19                 |
| Murmur3     | 1440013            |  29088.26                          |  2.02                 |
| CRC32       | 4773105            |  134601.56                         |  2.82                 |

| Хэш-функция | Время (-O3, такты) | Среднее отклонение времени (такты) | Процентная ошибка (%) |
|-------------|--------------------| ---------------------------------- | --------------------- |
| PJW32       | 642266             |  17854.99                          |  2.78                 |                                    
| Adler32     | 770131             |  15248.59                          |  1.98                 |
| SDBM32      | 694611             |  14864.67                          |  2.14                 |
| FNV32       | 691238             |  17419.19                          |  2.52                 |
| Murmur3     | 645002             |  11481.03                          |  1.78                 |
| CRC32       | 1650262            |  33170.26                          |  2.01                 |
...
| Хэш-функция | Время (-O3 + crc32 Intrinsics, такты) | Среднее отклонение времени (такты) | Процентная ошибка (%) |
|-------------|--------------------| ---------------------------------- | --------------------- |
| PJW32       | 653341             |  11629.46                          |  1.78                 |                                    
| Adler32     | 772306             |  15523.35                          |  2.01                 |
| SDBM32      | 695698             |  16140.19                          |  2.32                 |
| FNV32       | 683368             |  13394.01                          |  1.96                 |
| Murmur3     | 662906             |  10937.94                          |  1.65                 |
| CRC32       | 657693             |  10128.47                          |  1.54                 |
...
по сравнению со стандартной реализацией `strcmp` в `libc`. Однако стоит учитывать, что эта реализация является менее универсальной и безопасной.

Результаты:

| Хэш-функция | Время (-O3 + crc32 Intrinsics + strcmp Intrinrics, такты) | Среднее отклонение времени (такты) | Процентная ошибка (%) |
|-------------|--------------------| ---------------------------------- | --------------------- |
| PJW32       | 652275             |  27591.23                          |  4.23                 |                                    
| Adler32     | 770290             |  17023.40                          |  2.21                 |
| SDBM32      | 694486             |  15973.17                          |  2.30                 |
| FNV32       | 691994             |  16953.85                          |  2.45                 |
| Murmur3     | 657496             |  21828.86                          |  3.32                 |
| CRC32       | 645848             |  14079.48                          |  2.18                 |
...
| Хэш-функция | Время (-O3 + crc32 Intrinsics + strcmp Intrinsics + createNode ASM, такты) | Среднее отклонение времени (такты) | Процентная ошибка (%) |
|-------------|--------------------| ---------------------------------- | ---------------------- |
| PJW32       | 625838             | 9637.90                            | 1.54%                  |                                    
| Adler32     | 712821             | 9409.23                            | 1.32%                  |
| SDBM32      | 621773             | 11067.55                           | 1.78%                  |
| FNV32       | 609514             | 12068.37                           | 1.98%                  |
| Murmur3     | 581884             | 8964.01                            | 1.54%                  |
| CRC32       | 553139             | 7275.03                            | 1.32%                  |
...
| Хэш-функция | Время (-O3 + crc32 Intrinsics + strcmp Intrinsics + createNode ASM + adler32 ASM, такты) | Среднее отклонение времени (такты) | Процентная ошибка (%) |
|-------------|--------------------| ---------------------------------- | ---------------------- |
| PJW32       | ...                | ...                                | ...                    |                                    
| Adler32     | 599227             | 8568.94                            | 1.43%                  |
| SDBM32      | ...                | ...                                | ...                    |
| FNV32       | ...                | ...                                | ...                    |
| Murmur3     | ...                | ...                                | ...                    |
| CRC32       | ...                | ...                                | ...                    |
